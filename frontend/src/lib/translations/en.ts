...
export const translations: StaticTranslations = {
  ...
  "export": {
    ...
    "isoTitle": "APEDA Registered Exporter",
    "isoDesc": "RCMC-certified and APEDA-registered exporter, complying with India's agricultural export regulations and international quality standards. Ensuring traceability, regulatory compliance, and seamless global trade operations for all Dharaaveda products.",
  ...
  "products": {
    ...
    "items": {
      "f-banana": {
        "name": "Banana",
        "desc": "Naturally sweet Grand Naine and Cavendish bananas grown in nutrient-dense volcanic soil of Wayanad, exported in protective temperature-controlled atmospheres.",
      ...
      "f-pomegranate": {
        "name": "Pomegranate",
        "desc": "Juicy, deep-red Bhagwa pomegranate with soft seeds, high brix content, and rich antioxidant properties, sorted systematically via opto-electronic graders.",
        "pricing": "Contact Trade Desk",
        "spec": {
      ...
      "f-grapes": {
        "name": "Grapes",
        "desc": "Choice seedless green Thompson and black Sharad grapes. Crispy texture with balanced sweetness and optimum storage longevity.",
        "pricing": "Contact Trade Desk",
        "spec": {
      ...
      "f-guava": {
        "name": "Guava",
        "desc": "Vibrant pink-fleshed VNR Bihi and white-fleshed Lalit guavas known for their exceptional weight, minimal seeds, and exquisite tropical aroma.",
        "pricing": "Contact Trade Desk",
        "spec": {
      ...
      "f-mango": {
        "name": "Mango",
        "desc": "The supreme Alphonso (Hapus) and Kesar mangoes. Prized globally for intense golden color, fiberless pulp, and rich, cream-like flavor profile.",
        "pricing": "Contact Trade Desk",
        "spec": {
      ...
      "s-turmeric": {
        ...
        "desc": "Golden yellow powder from hand-selected Salem turmeric rhizomes. Extra-high curcumin levels (typically >5%) curated specifically for pharmaceutical applications.",
        "pricing": "Contact Trade Desk",
        "spec": {
      ...
      "s-redchilli": {
        ...
        "desc": "Vibrant red chilli powder from whole stemless Guntur Sannam and Kashmiri chillies, presenting deep aroma and customizable SHU heat levels.",
        "pricing": "Contact Trade Desk",
        "spec": {
      ...
      "s-coriander": {
        ...
        "desc": "Aromatic powder made of high-essential-oil coriander seeds. Adds sweet-warm, citrusy undertones to gourmet blends.",
        "pricing": "Contact Trade Desk",
        "spec": {
      ...
      "s-cumin": {
        "name": "Cumin Seeds",
        "desc": "Bold, dust-cleaned cumin seeds (Jeera) presenting optimal content of cuminaldehyde. Provides earthy and nutty flavor signatures.",
        "pricing": "Contact Trade Desk",
        "spec": {
      ...
      "s-blackpepper": {
        "name": "Black Pepper",
        "desc": "Bold Malabar Tellicherry Extra Bold Garbled pepper berries (TGSEB). Prized for its rich piperine heat and complex woodland fragrance.",
        "pricing": "Contact Trade Desk",
        "spec": {
      ...
      "s-cardamom": {
        "name": "Cardamom",
        "desc": "Stately 8mm+ giant green cardamom pods, meticulously dried to retain deep emerald color, sweet, highly complex resinous camphor flavor.",
        "pricing": "Contact Trade Desk",
        "spec": {
      ...
      "s-cinnamon": {
        "name": "Cinnamon",
        "desc": "Fragrant, hand-peeled quills of genuine Ceylon-type cinnamon. Sweet, smooth woodsy fragrance with very low coumarin levels, optimal for premium confectionery.",
        "pricing": "Contact Trade Desk",
        "spec": {
      ...
      "s-cloves": {
        "name": "Cloves",
        "desc": "Rich, aromatic whole cloves with high eugenol essential oil yield. Headed buds of bold shape and deep reddish-brown color.",
        "pricing": "Contact Trade Desk",
        "spec": {
      ...
      "s-fennel": {
        "name": "Fennel Seeds",
        "desc": "Bold, sweet fennel seeds (Saunf) exhibiting a bright green color. Best suited for digestif infusions and artisan baking.",
        "pricing": "Contact Trade Desk",
        "spec": {
      ...
      "s-mustard": {
        "name": "Mustard Seeds",
        "desc": "Bold black and yellow mustard seeds rich in oil content. Yields a sharp pungency for spice pastes, vinegars, and table spreads.",
        "pricing": "Contact Trade Desk",
        "spec": {
      ...
      "s-garammasala": {
        "name": "Garam Masala",
        "desc": "Classic blend of toasted cardamom, cinnamon, black pepper, cloves, mace, nutmeg, and cumin. Ground cold to preserve essential volatile esters.",
        "pricing": "Contact Trade Desk",
        "spec": {
      ...
      "s-currypowder": {
        "name": "Curry Powder",
        "desc": "International-spec Madras style curry powder blend. Perfectly balanced notes of coriander, mild chilli, fenugreek, and high-curcumin turmeric.",
        "pricing": "Contact Trade Desk",
        "spec": {
      ...
      "s-gingerpowder": {
        "name": "Ginger Powder",
        "desc": "Dehydrated and finely ground ginger root powder, yielding strong gingerol warmth and spicy sharpness. Highly sought by beverage and baking industries.",
        "pricing": "Contact Trade Desk",
        "spec": {
      ...
      "s-garlicpowder": {
        "name": "Garlic Powder",
        "desc": "Dehydrated, fine garlic powder curated from strong local Indian garlic clones, providing powerful allicin-driven aroma and instant flavor distribution.",
        "pricing": "Contact Trade Desk",
        "spec": {
      ...
      "s-onionpowder": {
        ...
        "desc": "Premium dehydrated red and white onion milled to powder. Delivers concentrated sweet, pungent onion zest immediately without moisture load.",
        "pricing": "Contact Trade Desk",
        "spec": {
      ...
      "d-onion": {
        "name": "Onion Flakes",
        "desc": "Carefully sliced and air-dehydrated premium red onions. Retains high pungency, light texture, and pristine visual flakes with long-term shelf stability.",
        "pricing": "Contact Trade Desk",
        "spec": {
      ...
      "d-garlic": {
        "name": "Garlic Flakes",
        "desc": "Golden-white, low-temperature dehydrated split garlic flakes. Robust allicin content, perfect for quick reconstitution in convenience foods.",
        "pricing": "Contact Trade Desk",
        "spec": {
      ...
      "d-tomato": {
        "name": "Tomato Powder",
        "desc": "Rich red powder obtained by spray-drying vine-ripened organic tomatoes. Imbues instant umami depth and classic tomato tang to soups, sauces, and savory mixes.",
        "pricing": "Contact Trade Desk",
        "spec": {
      ...
      "d-beetroot": {
        ...
        "desc": "Finely ground powder of dehydrated premium red beetroots, delivering intense crimson betalain dyes alongside sweet, natural nitrate-rich profiles.",
        "pricing": "Contact Trade Desk",
        "spec": {
      ...
      "d-spinach": {
        "name": "Spinach Powder",
        "desc": "Brilliant green powder dehydrated from iron-rich fresh spinach leaves. Highly soluble, yielding instant chlorophyll enrichment.",
        "pricing": "Contact Trade Desk",
        "spec": {
      ...
      "d-carrot": {
        "name": "Carrot Powder",
        "desc": "Rich orange powder from sweet dehydrated baby carrots, showcasing high Beta-Carotene retention and gentle dietary fiber richness.",
        "pricing": "Contact Trade Desk",
        "spec": {
      ...
      "d-greenchilli": {
        ...
        "desc": "Zesty green flakes chopped from fresh capsicums and chillies, preserving clean herbal warmth, capsaicinoids, and crisp green color.",
        "pricing": "Contact Trade Desk",
        "spec": {
      ...
      "d-drumstick": {
        ...
        "desc": "Drying of nutritious botanical drumstick pods. Packed with essential amino acids and micronutrients; excellent for daily health formulations.",
        "pricing": "Contact Trade Desk",
        "spec": {
      ...
      "d-moringa": {
        "name": "Moringa Powder",
        "desc": "Certified organically harvested, shadow-dried Miracle Tree (Moringa oleifera) leaves. Deep emerald powder loaded with vital vitamins, polyphenols, and complete proteins.",
        "pricing": "Contact Trade Desk",
        "spec": {
      ...
      "d-curryleaves": {
        ...
        "desc": "Made from fresh botanical curry leaves shadow-dehydrated immediately after harvest. Preserves aromatic, therapeutic terpene oils for health formulations and luxury cosmetics.",
        "pricing": "Contact Trade Desk",
        "spec": {
      ...
      "j-powder": {
        "name": "Jaggery Powder",
        "desc": "Free-flowing, non-sticky organic jaggery powder processed without chemical bleaching agents or toxic processing aids. Yields healthy mineral sweetening profiles.",
        "pricing": "Contact Trade Desk",
        "spec": {
      ...
      "j-cubes": {
        "name": "Jaggery Cubes",
        "desc": "Pre-measured, uniform blocks and cubes made of authentic high-purity jaggery. Dissolves cleanly, releasing deep molasses aroma.",
        "pricing": "Contact Trade Desk",
        "spec": {
