...
export const translations: StaticTranslations = {
  ...
  "home": {
    "div1": "Bölüm 01",
    "agriTitle": "Küresel Tarımsal İhracat Ağı",
    "agriDesc": "Organik hasadı doğrudan bağlayan, elle seçilmiş kakule, saf Shilajit reçinesi ve yüksek değerli bitkisel özler sunan premium tedarik zinciri çözümü. Yetkili fitosaniter testler, dökme yük taşımacılığı ve sıfır kayıplı lojistik.",
    "enterExport": "İhracat Masasına Giriş",
    "div2": "Bölüm 02",
    "wellnessTitle": "Holistik Sağlık & Enerji Terapisi",
    "wellnessDesc": "Dr. Edward Bach'ın zamansız çiçek özleri, biyo-enerji Usui Reiki ve Aura-Soma hizalanması. Sinir sisteminin, hücresel yorgunluğun ve kalıcı stresin tamamen iyileşmesi için Wayanad'da bulunan vadi sığınakları.",
    "exploreTherapies": "Terapileri Keşfedin",
    "inquiryHandling": "Talep Yönetimi",
    "annualDeals": "Yıllık Anlaşmalar",
    "wellnessSuccess": "Sağlık Başarısı",
    "recoveryRate": "İyileşme Oranı",
    "tradePresence": "Ticari Varlık",
    "nations": "Ülke",
    "nextAvailable": "Sıradaki Müsait Oturum",
    "availableSession": "24 Ekim, 09:30 — Reiki Rezonansı",
    "cinematic": "Sinematik Mükemmellik"
  },
  "export": {
  ...
  "booking": {
    ...
    "placeholderEmail": "ör. heinrich@wellbeing.com",
