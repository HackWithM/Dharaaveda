...
export const translations: StaticTranslations = {
  ...
  "footer": {
    ...
    "agriTitle": "Tarımsal Bölüm",
    "wellnessTitle": "Sağlık Bölümü",
    "corpTitle": "Kurumsal Ofis",
    "agriLink1": "Seçkin Baharatlar & Mutfak Mücevherleri",
    "agriLink2": "Saflaştırılmış Himalaya Shilajit Reçinesi",
    "agriLink3": "Saf Organik Aromaterapi Özleri",
    "agriLink4": "Özel Fitosaniter Sertifikasyon",
    "agriStatus": "● %100 İzlenebilirlik Denetimli",
    "wellnessLink1": "Edward Bach Floral Danışmanlıkları",
    "wellnessLink2": "Usui Reiki Kromatik Uyum",
    "wellnessLink3": "432Hz Kuvars Polifonik Akort",
  ...
  "home": {
    ...
    "heroSubtitle": "Dharaaveda, birinci sınıf tarımsal tedarik zincirlerini onarıcı enerjik terapilerle uyumlu hale getiriyor.",
    ...
    "exportCardDesc": "Hindistan'ın derin botanik çiftliklerini birinci sınıf küresel eczaneler, kozmetik mağazaları ve gıda ithalatçılarıyla birleştirmek. Mutlak bitki sağlığı uyumluluğu altında gönderilen birinci sınıf baharatlar, tahıllar ve adaptojenik özler.",
    ...
    "whyTrustDesc": "Tam şeffaflık, bitki sağlığına tam uyumluluk ve sertifikalı gizlilik protokolleri.",
    ...
    "whyExpertiseDesc": "Nesiller boyu süren tarımsal miras, sertifikalı enerjik uygulayıcılarla eşleşiyor.",
  ...
  "export": {
    ...
    "heroTitle": "Seçkin Ürün Lojistiği",
    "heroDesc": "DharaAveda, derin Hint bitki çiftliklerini küresel eczaneler, kozmetik evleri ve gıda ithalatçıları ile buluşturur. Sistemlerimiz, otantik Himalaya shilajit, dolgun kakule, vetiver baz yağları ve adaptojenik özlerin mutlak fitosaniter uyumluluk altında izlenebilir dökme nakliyesini garanti eder.",
    "apedaAuth": "APEDA Yetkili",
    "sgsPurity": "SGS Saflık Laboratuvarı Onaylı",
    "cargoTransit": "KÜRESEL KARGO NAKLİYESİ",
    "cargoDesc": "Deniz & Hava Taşımacılığı Rotaları",
    "secure": "GÜVENLİ",
    "catalogue": "DİNAMİK KATALOG",
    "selectGoods": "Tarımsal Ürünleri Seçin",
    "searchPlaceholder": "Kategori veya ürün arayın...",
    "noMatch": "Parametrelerinize uygun kategori veya ürün bulunamadı.",
    "adjustSearch": "Arama sorgunuzu değiştirmeyi deneyin.",
    "freightNetworks": "Küresel Navlun Ağları",
    "operationsTitle": "Dürüstlük Üzerine Kurulu Ticari Operasyonlar",
    "sgsTitle": "Tam SGS Doğrulaması",
    "sgsDesc": "Her parti, gaz kromatografisi ve analitik saflık testlerinden geçer. Fitosaniter uyum, liman gümrüklerinde sorunsuz bir rotayı garanti eder.",
    "isoTitle": "ISO Karşılıklı Standart",
    "isoDesc": "Titiz uluslararası hijyen kuralları altında faaliyet gösteriyoruz. Vakumlu paketleme, taşıma sırasında kozmik UV ışınlarını bloke ederek tazeliği korur.",
    "originTitle": "Wayanad Doğrudan Menşei",
    "originDesc": "Baharat çiftliğimiz, gereksiz aracıları ortadan kaldırarak yerel Vedik küçük ölçekli çiftçilere doğrudan adil ücret ödenmesini sağlar.",
    "fastTrack": "HIZLI TEKLİF",
    "speakArbitrage": "Emtia Arbitraj masamızla görüşün",
    "arbitrageDesc": "Özel nem içeriği, yüksek tonaj veya deniz konteyneri nakliye sözleşmelerine mi ihtiyacınız var? Öncelikli ticaret yönetimi için doğrudan bağlantı kurun.",
    "cargoTimelines": "Tipik Kargo Zaman Çizelgesi",
    "sgsClearance": "SGS analiz onayı:",
    "sgsDays": "4-5 İş Günü",
  ...
  "booking": {
    ...
    "sanctuary": "Titreşimsel Sığınak",
    "desc": "Tüm danışmanlıklar tam bir gizlilik içinde yürütülür. Terapistlerimiz, fiziksel serbest kalmayı ve iyileşmeyi kolaylaştırmak için aktif stres alanlarıyla eşleşen özel çareler formüle eder.",
    "confidential": "Gizli Alım",
    "confidentialDesc": "Biyoalan haritalamanız, termal teşhisleriniz ve vaka geçmişleriniz mühürlü kalır.",
    "private": "Özel Rezidanslar",
    "privateDesc": "Odalar, Hindistan'ın Kerala eyaletindeki derin Wayanad orman bahçelerimizin içinde izole edilmiştir.",
    "aligning": "Aura Teşhisleri Hizalanıyor...",
    "scheduler": "Harmonik Rezidans Planlayıcısı",
    "title": "Terapinizi Planlayın",
    "formDesc": "Özel karışım Bach çiçeği, Reiki hizalanması veya derin kuvars terapötik ses şifasını ayırtın.",
    "successTitle": "Rezidans Rezervasyonu Başlatıldı",
    "successDesc": "Teşekkürler, {name}. {service} için randevu talebiniz güvenli sığınak defterimize işlenmiştir.",
    "slipTitle": "Talep Edilen Oturum Fişi",
    "date": "Tarih",
    "hour": "Saat",
    "note": "Klinik koordinatörümüz, biyo-rezonans giriş dosyalarını kesinleştirmek için sizi arayacak veya e-posta gönderecektir.",
    "anotherBtn": "Başka Bir Oturum Ayırtın",
    "labelName": "Adınız Soyadınız *",
    "labelEmail": "İletişim E-posta Adresi *",
    "labelPhone": "Doğrudan Telefon *",
    "labelService": "Terapötik Uyum Hizmeti *",
    "labelDate": "Giriş Rezidans Tarihi *",
    "labelTime": "Tercih Edilen Varış Zamanı *",
    "labelNotes": "Enerjisel Belirtiler, Stres Tetikleyicileri veya Gıda Tercihleri",
    "placeholderName": "ör. Heinrich Müller",
    "placeholderEmail": "ör. sales@dharaaveda.com",
    "placeholderPhone": "+91 9175462485",
    "placeholderNotes": "Herhangi bir fiziksel ağrıdan, yaşam blokajlarından, duygusal sıkıntı modellerinden bahsedin veya kadın/erkek uygulayıcı tercihinizi belirtin...",
    "errorFields": "Lütfen * ile işaretlenmiş tüm zorunlu alanları doldurun.",
    "submitting": "Defter Rezervasyonu İletiliyor...",
    "submit": "Uyum Defterini Onaylayın",
    "loadingModalities": "Kutsal Yöntemler Yükleniyor...",
    "pickSlot": "Zaman Dilimi Seçin...",
    "slot1": "08:00 - Gün Doğumu Çiy Alımı",
    "slot2": "11:00 - Güneş Zenit Senkronizasyonu",
    "slot3": "14:30 - Öğleden Sonra Yıldız Işığı",
    "slot4": "17:30 - Wayanad Gün Batımı Huzuru"
  },
  "contact": {
    "accessLines": "DOĞRUDAN ERİŞİM HATLARI",
    "council": "DharaAveda Konseyi ile İletişime Geçin",
    "desc": "Dökme baharat operasyonları için nakliye gemileri ayarlarken veya özel klinik iyileşme kabulleri planlarken, temsilcilerimiz seçkin kurumsal bakım sağlar.",
    "exportDesk": "İHRACAT LOJİSTİK MASASI",
    "cargoAffairs": "Emtia & Deniz Kargo İşleri",
    "sanctuaryAdmissions": "SIĞINAK VİLLA KABULLERİ",
    "healingReserves": "Holistik İyileşme Rezervleri",
    "responseRate": "Emtia sözleşmesi aracılarının ortalama yanıt süresi 24 iş saatidir.",
    "transmissionSealed": "İletim Mühürlendi",
    "transmissionDesc": "Mesajınız, {name}, işlenmiştir. İlgili bölümden bir konsey danışmanı kısa süre içinde sizinle iletişime geçecektir.",
    "sendAnother": "Başka Bir Mesaj Gönderin",
    "labelName": "Adınız Soyadınız *",
    "labelEmail": "E-posta Adresi *",
    "labelPhone": "Doğrudan İletişim Telefonu",
    "labelMessage": "Sorgularınız / Gereksinimleriniz *",
    "placeholderName": "ör. Heinrich Müller",
  ...
  "product": {
    ...
    "premiumItems": "Seçkin Ürünler",
    "viewProducts": "Ürünleri Görüntüle",
    "titleCatalogue": "Katalog",
    "availableCargo": "Müsait Kargo Partileri",
    "minOrder": "Min Sipariş",
    "pricingModel": "Fiyatlandırma Modeli",
    "sendInquiry": "Talep / Teklif Gönder",
    "close": "Kapat",
    "apedaCompliant": "APEDA Uyumlu İhracat Kargo Standardı",
    "inquiryRequestQuote": "Fiyat Teklifi İsteyin",
    "inquiryDirectAccess": "Tarımsal İhracat Masamıza doğrudan erişim için",
    "inquirySuccessTitle": "Fiyat Teklifi Talebi Günlüğe Kaydedildi",
    "inquirySuccessDesc": "Ticaret masası biletiniz başlatıldı. Özel bir kargo uzmanı, kargo spesifikasyonlarınızı 24 standart iş saati içinde inceleyecektir.",
    "inquiryCloseWindow": "Pencereyi Kapat",
    "inquiryLabelName": "Ad Soyad *",
    "inquiryLabelEmail": "Kurumsal E-posta *",
    "inquiryLabelCompany": "Şirket / Organizasyon",
    "inquiryLabelQuantity": "Hedef Miktar (örn. Ton) *",
    "inquiryPlaceholderName": "ör. Elena Rostova",
    "inquiryPlaceholderEmail": "sales@dharaaveda.com",
    "inquiryPlaceholderCompany": "ör. Hanseatic Spices GmbH",
    "inquiryPlaceholderQuantity": "ör. 5 Metrik Ton",
    "inquiryPlaceholderMessage": "Özel vakumlu mühür taleplerini, liman tercihlerini (örn. Rotterdam, Hamburg) ve fitosaniter sertifika ihtiyaçlarını belirtin...",
    "inquiryLoggingSpecs": "Kargo Özellikleri Kaydediliyor...",
    "inquirySubmit": "Talebi İletin",
    "inquiryErrorFields": "Lütfen tüm zorunlu alanları doldurun."
  },
  "wellness": {
    "floatingCTAText": "Oturumu Hizalayın",
    "heroBadge": "Onarıcı Kuantum Sığınağı",
    "heroTitle": "Yatıştırıcı Kuantum Uyum",
    "heroDesc": "Gerçek uzun ömür, yapısal stresin çözüldüğü yerde başlar. DharaAveda Sığınağı, klasik Edward Bach kır çiçeği ilaçlarını, Usui Reiki çakra hizalamasını, Aura-Soma krom-esansiyel yağlarını ve sürükleyici 432Hz kuvars ses dalgalarını harmanlar. Aurik frekansınızı hizalayın, derin yaşam döngüsü travmalarını temizleyin ve mutlak biyolojik huzuru geri kazanın.",
    "heroExploreBtn": "Sığınak Yöntemlerini Keşfedin",
    "modalitiesBadge": "KADİM BİLGİ GERİ KAZANILDI",
    "modalitiesTitle": "Terapötik Yöntemlerimiz",
    "modalitiesDesc": "Her klinik rezidans oturumu, fiziksel ve duygusal rahatlama için özel frekanslar harmanlanarak kişiye özel olarak düzenlenir.",
    "modalityNoServices": "Titreşimsel şifa takvimleri ayarlanıyor...",
    "modalityTimelineTitle": "Kronolojik Oturum Yolu",
    "modalityRequestBtn": "Rezidans Talep Edin",
    "testimonialsBadge": "HARMONİK YEMİNLER",
    "testimonialsTitle": "Uyumlanmış Rahatlamanın Sesleri",
    "testimonialsNoData": "Görüşler, müşteri gizlilik dosyaları açıldığında yüklenecektir.",
    "reviewsBadge": "OTANTİK YANKILAR",
    "reviewsTitle": "Sosyal Medya Yönergeleri",
    "reviewsDesc": "Enerjik uyumlamalarımızı deneyimleyen müşterilerden gelen dijital konuşmaların ve halka açık geri bildirimlerin doğrudan anlık görüntüleri.",
    "reviewsEmpty": "Henüz yüklenmiş sosyal medya ekran görüntüsü incelemesi yok.",
    "reviewsExpand": "Görseli Genişlet",
    "badgeWhatsapp": "WhatsApp İncelemesi",
    "badgeInstagram": "Instagram İncelemesi",
    "aboutBadge": "KURUCU & USTA UYGULAYICI",
    "aboutPhilosophyTitle": "Rezonans Felsefemiz",
    "faqBadge": "KUTSAL BİLGİ SSS",
    "faqTitle": "Uyumlanma Soruları",
    "faqDesc": "Enerji ve adaptojenik terapötik rezidans programlarımızla ilgili tekrarlayan düşüncelere yanıtlar.",
    "faqItems": [
      {
        "question": "Reiki, Bach Çiçeği ve Ses hizalaması arasında nasıl seçim yaparım?",
        "answer": "İlk rezervasyon görüşmemizde acil duygusal veya fiziksel zorluklarınızı paylaşmanızı öneririz. Dr. Vikranti ve ekibi, rezonans frekansınıza göre özel yöntemler dokumak için enerjik biyoalanınızı tarayacaktır."
      },
      {
        "question": "Bu terapi döngüleri şahsen mi yoksa çevrimiçi mi yapılıyor?",
        "answer": "Usui Reiki ve Ses Uyumlaması, saf Wayanad Villa inzivamızda oldukça sürükleyici olsa da, Bach Çiçeği duygusal danışmanlıkları ve seçici enerji biyoalan desteği, eşit ruhsal güçle çevrimiçi olarak gerçekleştirilebilir."
      },
      {
        "question": "Bu terapiler modern geleneksel tedavilerle entegre edilebilir mi?",
        "answer": "Kesinlikle. Yöntemlerimiz, hücresel stresi çözerek ve hızlandırılmış somatik kendi kendine iyileşme döngülerini kolaylaştırarak geleneksel klinik tıbbı tamamlayan sübtil enerji bedenleri (pranamaya kosha) ve duygusal alanlar üzerinde çalışır."
      }
    ],
    "locationBadge": "WAYANAD DAĞ İKLİMİ",
    "locationTitle": "Wayanad Villa İnzivası",
    "locationDesc": "Ana klinik odalarımız, Wayanad, Kerala'nın sisli yaylalarında yer almaktadır. Klinik tesis, derin biyoalan iyileşmesini sağlamak için yüksek negatif iyon seviyelerine, doğal akan dağ suyu kaynağına ve elektromanyetik radyasyon gürültüsünün mutlak yokluğuna sahiptir.",
    "locationBanner": "Wayanad, Kerala Sığınağı",
    "writeReview": "İnceleme Yazın",
    "ratingTitle": "Uyumlanmış Memnuniyet Derecesi",
    "ratingSub": "Doğrulanmış ruhsal rezonans referanslarına dayanmaktadır.",
    "visitorEcho": "Ziyaretçi Sığınak Yankısı",
    "shareReview": "Sığınak Deneyiminizi Paylaşın",
    "feedbackGuideline": "Kutsal geri bildiriminiz toplumsal yolumuzu yönlendirir ve usta simyacımız tarafından onaylanır.",
    "labelResonanceRating": "Kuantum Rezonans Derecesi*",
    "labelSilhouette": "Silüet Portresi Seçin (İsteğe bağlı)",
    "placeholderReview": "Duygularınızı, duygusal dengenizi veya fiziksel rahatlamanızı açıklayın...",
    "btnSubmitReview": "İncelemeyi Gönder",
    "btnDiscard": "Vazgeç",
    "reviewSuccessTitle": "Yankı Alındı!",
    "reviewSuccessDesc": "Uyumlanmış deneyiminizi paylaştığınız için teşekkür ederiz. İncelemeniz kayıtlara geçmiştir ve Sığınak Moderatörümüz tarafından incelenip onaylandıktan sonra yayına girecektir.",
    "btnPerfect": "Mükemmel",
    "reviewTransmitting": "İletiliyor...",
    "reviewNameLabel": "Ad Soyad*",
    "reviewCityLabel": "Şehir / Ülke (İsteğe bağlı)",
    "reviewAvatarLabel": "Veya özel fotoğraf URL'si girin...",
    "reviewTitleDefault": "Sağlık Ziyaretçisi",
    "reviewErrorName": "Ad Soyad zorunludur",
    "reviewErrorContent": "İnceleme Mesajı zorunludur",
    "reviewErrorRating": "Derece 1 ile 5 yıldız arasında olmalıdır",
    "reviewsModality": "YÖNTEM REZİDANSI"
  },
  "products": {
    "categories": {
      "spices": {
  ...
  "seo": {
    ...
    "wellnessTitle": "Onarıcı Kuantum Tapınağı ve Terapileri | DharaAveda",
    ...
    "bookingTitle": "Uyumlama Uzmanlığınızı Programlayın | DharaAveda",
    "bookingDesc": "Reiki uyumlaması, Bach çiçek konsültasyonları veya derin ses şifası için gizli alım seansınızı ayırın.",
    "contactTitle": "Konsey Masasıyla İletişime Geçin | DharaAveda",
